...
const App: React.FC = () => {
  ...
  // Плейсхолдеры для изображений (замените URL на свои после загрузки на GitHub)
  const placeholder1 = "https://raw.githubusercontent.com/bemotte-ops/Hebrew/main/pic1.png";
  const placeholder2 = "https://raw.githubusercontent.com/bemotte-ops/Hebrew/main/pic2.png";
  const placeholder3 = "https://raw.githubusercontent.com/bemotte-ops/Hebrew/main/pic3.png";
  const placeholder4 = "https://raw.githubusercontent.com/bemotte-ops/Hebrew/main/pic4.png";
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-teal-100">
      ...
      <main className="max-w-5xl mx-auto pb-24 px-6 space-y-16 mt-16">
        ...
        {/* ЧАСТЬ 1: История и эволюция языка */}
        <div className="space-y-12">
          {/* Плейсхолдер 1 */}
          <div className="w-full overflow-hidden rounded-[2.5rem] border border-teal-200 shadow-sm">
            <img 
              src={placeholder1} 
              alt="История языка" 
        ...
        {/* ЧАСТЬ 2: Алфавит и корневая система */}
        <div className="space-y-12">
          {/* Плейсхолдер 2 */}
          <div className="w-full overflow-hidden rounded-[2.5rem] border border-teal-200 shadow-sm">
            <img 
        ...
        {/* ЧАСТЬ 3: Алфавит и гематрия */}
        <div className="space-y-12">
          {/* Плейсхолдер 3 */}
          <div className="w-full overflow-hidden rounded-[2.5rem] border border-teal-200 shadow-sm">
            <img 
              src={placeholder3} 
              alt="Гематрия и символы" 
              className="w-full h-auto object-cover"
              onError={handleImageError}
            />
          </div>
        ...
        {/* ЧАСТЬ 4: Софит и гематрия, Тетраграмматон */}
        <div className="space-y-12">
          {/* Плейсхолдер 4 */}
          <div className="w-full overflow-hidden rounded-[2.5rem] border border-teal-200 shadow-sm">
            <img 
