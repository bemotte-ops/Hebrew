...
const App: React.FC = () => {
  const alphabet: Letter[] = [
    ...
    { letter: 'ח', name: 'Хет', proto: '𓉗', meaning: 'Ограда', evolution: 'Рисовалась как забор или стена, защищающая частную территорию от диких зверей и врагов. Ограда дает безопасность, но она же создает границы, внутри которых процветает жизнь.', number: 8, examples: ['חי (Жизнь)', 'חסд (Милость)'], philosophy: 'Динамическая энергия жизни, пробивающаяся через препятствия. Символизирует способность преодолевать материальные границы.', historyNote: 'Арабская Ха (ح). Глубокий гортанный звук.' },
            ...
            <div className="overflow-hidden border border-slate-200 rounded-3xl">
              <table className="w-full text-left border-collapse bg-white">
                ...
                <tbody className="divide-y divide-slate-50">
                  ...
                  <tr className="hover:bg-teal-50/30 transition-colors">
                    <td className="p-5 text-2xl font-serif text-teal-700">ספר — מכתב</td>
