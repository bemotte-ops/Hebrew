...
const App: React.FC = () => {
  const alphabet: Letter[] = [
    ...
    { letter: 'ו', name: 'Вав', proto: '𓏳', meaning: 'Крючок', cyrillic: 'В / У / О', evolution: 'Изображала колышек для крепления шатра. Эта деталь была важна для устойчивости жилища, объединяя части ткани', number: 6, examples: ['ו [Ве] — И', 'ורד [Веред] — Роза'], philosophy: 'Сила соединения и вертикальная связь между небом и землей', historyNote: 'Стала латинской F и Y через греческие трансформации' },
    { letter: 'ז', name: 'Заин', proto: '𓏴', meaning: 'Оружие', cyrillic: 'З', evolution: 'Напоминала меч или скипетр, символизируя защиту и власть. Это знак борьбы и седьмого дня', number: 7, examples: ['זמן [Зман] — Время', 'זהב [Заhав] — Золото'], philosophy: 'Святость времени и борьба духа. Число семь указывает на завершенность цикла', historyNote: 'Арабская Зай' },
    { letter: 'ח', name: 'Хет', proto: '𓉗', meaning: 'Ограда', cyrillic: 'Х (твёрдая)', evolution: 'Рисовалась как забор, защищающий территорию. Ограда дает безопасность, но она же создает границы', number: 8, examples: ['חי [Хай] — Жизнь', 'חסד [Хесед] — Милость'], philosophy: 'Динамическая энергия жизни, пробивающаяся через препятствия', historyNote: 'Арабская Ха. Глубокий гортанный звук' },
    { letter: 'ט', name: 'Тет', proto: '𓇽', meaning: 'Корзина', cyrillic: 'Т', evolution: 'Символ свернутого предмета или щита, внутри которого скрыто нечто ценное', number: 9, examples: ['טוב [Тов] — Добро', 'טבע [Тева] — Природа'], philosophy: 'Скрытое добро и чистота души. Число девять символизирует период подготовки', historyNote: 'Арабская Та' },
    { letter: 'י', name: 'Йод', proto: '𓂝', meaning: 'Рука', cyrillic: 'Й / И', evolution: 'Самая маленькая буква, произошедшая от изображения кисти руки. Является частью почти всех остальных букв', number: 10, examples: ['יד [Яд] — Рука', 'ישראל [Исраэль] — Израиль'], philosophy: 'Точка бесконечности, из которой разворачивается всё мироздание', historyNote: 'В латыни превратилась в I и J' },
    { letter: 'כ', suffix: 'ך', name: 'Каф', proto: '𓂬', meaning: 'Ладонь', cyrillic: 'К / Х', evolution: 'Изображение согнутой ладони, готовой принять дар. Это символ материализации идей', number: 20, examples: ['כוח [Коах] — Сила', 'כבוד [Кавод] — Честь'], philosophy: 'Реализация потенциала и сила воображения', historyNote: 'Имеет конечную форму (Софит) — ך' },
    ...
    { letter: 'נ', suffix: 'ן', name: 'Нун', proto: '𓆓', meaning: 'Рыба', cyrillic: 'Н', evolution: 'Изначально изображала извивающуюся змею или рыбу. Символ жизненности и плодовитости', number: 50, examples: ['נשמה [Нешама] — Душа', 'נס [Нес] — Чудо'], philosophy: 'Символ вечной души и искренности. Способность подниматься после падения', historyNote: 'Конечная форма — ן' },
    ...
    { letter: 'צ', suffix: 'ץ', name: 'Цади', proto: '𓇑', meaning: 'Крючок', cyrillic: 'Ц', evolution: 'Изображала рыболовный крючок. Позже смысл трансформировался в образ праведника', number: 90, examples: ['צדק [Цедек] — Правда', 'צפון [Цафон] — Север'], philosophy: 'Стремление к справедливости и этическая чистота', historyNote: 'Конечная форма — ץ.' },
    { letter: 'ק', name: 'Куф', proto: '𓃻', meaning: 'Ушко иглы', cyrillic: 'К', evolution: 'Возможно, изображала затылок или ушко иглы. Символ святости в материальном мире', number: 100, examples: ['קדושה [Кдуша] — Святость', 'קול [Коль] — Голос'], philosophy: 'Преобразование тьмы в свет', historyNote: 'Арабская Каф' },
    { letter: 'ר', name: 'Реш', proto: '𓁶', meaning: 'Голова', cyrillic: 'Р', evolution: 'Изображение головы человека в профиль. Символ интеллекта и самосознания', number: 200, examples: ['ראש [Рош] — Голова', 'רוח [Руах] — Дух'], philosophy: 'Начало нового этапа и чистота мысли', historyNote: 'Арабская Ра' },
  ...
  // ЗАМЕНИТЕ ЭТИ ССЫЛКИ НА ВАШИ ИЗОБРАЖЕНИЯ ПОСЛЕ ЗАГРУЗКИ НА GITHUB
  const bgImage1 = "https://raw.githubusercontent.com/bemotte-ops/Hebrew/main/pic1.png";
  const bgImage2 = "https://raw.githubusercontent.com/bemotte-ops/Hebrew/main/pic2.png";
  const bgImage3 = "https://raw.githubusercontent.com/bemotte-ops/Hebrew/main/pic3.png";
  const bgImage4 = "https://raw.githubusercontent.com/bemotte-ops/Hebrew/main/pic4.png";
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-teal-100">
      ...
      {/* Header Section (оставляем как есть) */}
      ...
      {/* Основной контент разбит на 4 секции с разными фонами */}
      
      {/* СЕКЦИЯ 1: История языка (первый фон) */}
      <div 
        className="relative bg-cover bg-center bg-fixed py-16"
        style={{ backgroundImage: `url(${bgImage1})` }}
      >
        {/* Полупрозрачный оверлей для читаемости контента */}
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6">
          <div className="space-y-12">
            ...
            {/* 2. Direction Block */}
            <section className="p-8 md:p-12 rounded-[2.5rem] shadow-sm border space-y-6">
              <div className="text-center space-y-3">
      ...
      {/* СЕКЦИЯ 2: Алфавит и корни (второй фон) */}
      <div 
        className="relative bg-cover bg-center bg-fixed py-16"
      ...
      {/* СЕКЦИЯ 3: Генезис символов и алфавит (третий фон) */}
      <div 
        className="relative bg-cover bg-center bg-fixed py-16"
      ...
      {/* СЕКЦИЯ 4: Софит, гематрия и Тетраграмматон (четвертый фон) */}
      <div 
        className="relative bg-cover bg-center bg-fixed py-16"
          ...
          <div className="space-y-12">
            ...
            <section className="bg-white p-10 md:p-14 rounded-[4rem] border border-teal-200 relative overflow-hidden">
              <div className="relative z-10 space-y-10">
                ...
                <p className="text-lg font-patrick text-slate-700">
