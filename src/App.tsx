...
const App: React.FC = () => {
  const alphabet: Letter[] = [
    { letter: 'א', name: 'Алеф', proto: '𓃾', meaning: 'Бык / Сила', evolution: 'Древнейший символ, изображающий голову быка с рогами, что олицетворяло первозданную мощь и лидерство в хозяйстве древних семитов. Со временем изображение повернулось, превратившись в греческую Альфу и латинскую А, но в иврите сохранило свою беззвучную природу', number: 1, examples: ['אור [Ор] — Свет', 'אמת [Эмет] — Истина'], philosophy: 'Символизирует абсолютное единство и начало всего сущего. Это беззвучный выдох, из которого рождаются все остальные звуки вселенной', historyNote: 'Прямой предок арабского Алифа и греческой Альфы' },
    { letter: 'ב', name: 'Бет', proto: '𓉐', meaning: 'Дом', evolution: 'Изначально рисовался как план жилого помещения или шатра кочевника с четко обозначенным входом. Этот знак подчеркивает идею разделения внешнего и внутреннего миров, создавая защищенное пространство', number: 2, examples: ['בית [Байт] — Дом', 'ברכה [Браха] — Благословение'], philosophy: 'Это «сосуд» для божественной энергии. Первая буква Торы, указывающая на то, что творение началось с создания дома для человечества', historyNote: 'Связана с арабской Ба (ب)' },
    { letter: 'ג', name: 'Гимель', proto: '𓄿', meaning: 'Верблюд', evolution: 'Напоминает шею верблюда или ногу бегущего человека, символизируя длинные путешествия через пустыню. Верблюд был «кораблем пустыни», обеспечивающим связь между далекими цивилизациями и передачу товаров', number: 3, examples: ['גמל [Гамаль] — Верблюд', 'גשר [Гешер] — Мост'], philosophy: 'Символ вознаграждения и милосердия. Гимель олицетворяет богатого человека, который бежит за бедняком (Далет), чтобы помочь ему', historyNote: 'Арабская Джим (ج)' },
    { letter: 'ד', name: 'Далет', proto: '𓇯', meaning: 'Дверь', evolution: 'Обозначает вход в шатер или проем в стене, через который можно войти или выйти. Этот символ неразрывно связан со смирением, так как входящий должен склонить голову, а само слово созвучно слову «бедность»', number: 4, examples: ['דלת [Делет] — Дверь', 'דעת [Даат] — Знание'], philosophy: 'Олицетворяет выбор пути и переход из одного состояния в другое. Четверка символизирует четыре стороны света', historyNote: 'В древних надписях выглядела как треугольник' },
    { letter: 'ה', name: 'Хей', proto: '𓀠', meaning: 'Окно / Выдох', evolution: 'Происходит от изображения человека с поднятыми руками, выражающего восторг или молитву. Позже трансформировалась в символ окна, через которое в дом проникает свет и воздух, дарующий жизнь', number: 5, examples: ['הוד [hод] — Величие', 'הלлуя [hаллелуя] — Аллилуйя'], philosophy: 'Дыхание жизни, легкий звук, который не требует усилий. Считается, что этот мир был создан с помощью звука этой буквы', historyNote: 'Родственна арабской Ха (هـ)' },
    { letter: 'ו', name: 'Вав', proto: '𓏳', meaning: 'Крючок', evolution: 'Изображала колышек для крепления шатра или соединительный крюк. Эта деталь была критически важна для устойчивости жилища в условиях ветреной пустыни, объединяя разрозненные части ткани', number: 6, examples: ['ו [Ве] — И', 'ורд [Веред] — Роза'], philosophy: 'Сила соединения и вертикальная связь между небом и землей. В языке служит союзом «и», буквально связывая слова и смыслы', historyNote: 'Стала латинской F и Y через греческие трансформации' },
    { letter: 'ז', name: 'Заин', proto: '𓏴', meaning: 'Оружие', evolution: 'Первоначально напоминала меч, кинжал или скипетр, символизируя защиту и власть. Это знак борьбы, но также и символ седьмого дня, который охраняет святость всей недели', number: 7, examples: ['זמן [Зман] — Время', 'זהב [Заhав] — Золото'], philosophy: 'Святость времени и борьба духа. Число семь указывает на завершенность природного цикла.', historyNote: 'Арабская Зай (ز)' },
    { letter: 'ח', name: 'Хет', proto: '𓉗', meaning: 'Ограда', evolution: 'Рисовалась как забор или стена, защищающая частную территорию от диких зверей и врагов. Ограда дает безопасность, но она же создает границы, внутри которых процветает жизнь', number: 8, examples: ['חי [Хай] — Жизнь', 'חסד [Хесед] — Милость'], philosophy: 'Динамическая энергия жизни, пробивающаяся через препятствия. Символизирует способность преодолевать материальные границы', historyNote: 'Арабская Ха (ح). Глубокий гортанный звук' },
    { letter: 'ט', name: 'Тет', proto: '𓇽', meaning: 'Корзина', evolution: 'Символ свернутого предмета, корзины или щита, внутри которого скрыто нечто ценное. Это образ потенциала, который еще не проявлен вовне, но содержит в себе полноту будущего добра', number: 9, examples: ['טוב [Тов] — Добро', 'טבע [Тева] — Природа'], philosophy: 'Скрытое добро и чистота души. Число девять символизирует период беременности — время подготовки к рождению нового', historyNote: 'Арабская Та (ط)' },
    { letter: 'י', name: 'Йод', proto: '𓂝', meaning: 'Рука', evolution: 'Самая маленькая буква, произошедшая от изображения кисти руки. Несмотря на малый размер, она является частью почти всех остальных букв и символизирует божественную искру в материи', number: 10, examples: ['יד [Яд] — Рука', 'ישראל [Исраэль] — Израиль'], philosophy: 'Точка бесконечности, из которой разворачивается всё мироздание. Олицетворяет смирение и потенциал действия', historyNote: 'В латыни превратилась в I и J' },
    { letter: 'כ', suffix: 'ך', name: 'Каф', proto: '𓂬', meaning: 'Ладонь', evolution: 'Изображение согнутой ладони, готовой принять дар или начать работу. Это символ материализации идей, когда абстрактная мысль обретает физическую форму через труд', number: 20, examples: ['כוח [Коах] — Сила', 'כבוד [Кавод] — Честь'], philosophy: 'Реализация потенциала и сила воображения. Каф учит нас оформлять свои желания в конкретные действия', historyNote: 'Имеет конечную форму (Софит) — ך' },
    { letter: 'ל', name: 'Ламед', proto: '𓋿', meaning: 'Посох', evolution: 'Пастуший посох или стрекало для управления скотом. Пастух использовал его, чтобы направлять стадо, поэтому буква стала символом обучения и дисциплины', number: 30, examples: ['לב [Лев] — Сердце', 'לימוד [Лимуд] — Учение'], philosophy: 'Самая высокая буква алфавита, устремленная вверх. Символизирует стремление сердца к познанию высших истин', historyNote: 'Арабская Лям (ل). Высокая буква' },
    { letter: 'מ', suffix: 'ם', name: 'Мем', proto: '𓈖', meaning: 'Вода', evolution: 'Происходит от волнистой линии, изображающей поверхность воды. Вода — это источник жизни, но также символ изменчивости и глубокой мудрости океана', number: 40, examples: ['מים [Маим] — Вода', 'מלך [Мелех] — Царь'], philosophy: 'Поток времени и глубина сознания. Сорок дней — период очищения и обновления', historyNote: 'Имеет закрытую конечную форму — ם' },
    { letter: 'נ', suffix: 'ן', name: 'Нун', proto: '𓆓', meaning: 'Рыба', evolution: 'Изначально изображала извивающуюся змею или рыбу в движении. Это символ жизненности в водной стихии, плодовитости и верности своему источнику', number: 50, examples: ['נשמה [Нешама] — Душа', 'נס [Нес] — Чудо'], philosophy: 'Символ вечной души и искренности. Нун учит нас падать и снова подниматься, сохраняя свет веры', historyNote: 'Конечная форма — ן. Арабская Нун (ن)' },
    { letter: 'ס', name: 'Самех', proto: '𓊽', meaning: 'Опора', evolution: 'Древний знак, напоминающий скелет рыбы или подпорку для дерева. Это круговая защита, щит, который поддерживает слабого, создавая замкнутый контур безопасности', number: 60, examples: ['סוד [Сод] — Тайна', 'ספר [Сефер] — Книга'], philosophy: 'Божественная поддержка и цикличность. Замкнутый круг Самех напоминает нам о защите Творца', historyNote: 'В арабском функции перешли к Син (س)' },
    { letter: 'ע', name: 'Аин', proto: '𓁹', meaning: 'Глаз', evolution: 'Четкое изображение глаза с зрачком. Этот символ призывает нас не просто смотреть на поверхность вещей, а видеть их истинную внутреннюю суть', number: 70, examples: ['עולם [Олам] — Мир', 'עבודה [Авода] — Работа'], philosophy: 'Глубокое понимание и прозрение. Аин говорит о том, что наше восприятие определяет реальность', historyNote: 'Сложный гортанный звук Айн (ع)' },
    { letter: 'פ', suffix: 'ף', name: 'Пе', proto: '𓂊', meaning: 'Рот', evolution: 'Очертание открытого рта. Это инструмент коммуникации, через который человек выражает мысли, творит молитву или разрушает мир сплетнями', number: 80, examples: ['פה [Пэ] — Рот', 'פנים [Паним] — Лицо'], philosophy: 'Сила слова и свобода речи. Пе учит нас ответственности за каждое произнесенное слово', historyNote: 'Конечная форма — ף. Арабская Фа (ف)' },
    { letter: 'צ', suffix: 'ץ', name: 'Цади', proto: '𓇑', meaning: 'Крючок', evolution: 'Изображала рыболовный крючок или ловушку. Позже смысл трансформировался в образ «праведника», чьи мысли всегда обращены к небу', number: 90, examples: ['צדק [Цедек] — Правда', 'צפון [Цафон] — Север'], philosophy: 'Стремление к справедливости и этическая чистота. Цади символизирует победу духа', historyNote: 'Конечная форма — ץ. Арабская Сад (ص)' },
    { letter: 'ק', name: 'Куф', proto: '𓃻', meaning: 'Ушко иглы', evolution: 'Возможно, изображала затылок или ушко иглы. Это символ святости, которая способна проникнуть даже в самые плотные слои материального мира', number: 100, examples: ['קדושה [Кдуша] — Святость', 'קול [Коль] — Голос'], philosophy: 'Преобразование тьмы в свет. Куф напоминает о том, что даже во тьме можно найти искры божественного', historyNote: 'Арабская Каф (ق)' },
    { letter: 'ר', name: 'Реш', proto: '𓁶', meaning: 'Голова', evolution: 'Изображение головы человека в профиль. Это символ интеллекта, самосознания и главенства разума над телом', number: 200, examples: ['ראש [Рош] — Голова', 'רוח [Руах] — Дух'], philosophy: 'Начало нового этапа и чистота мысли. Реш призывает нас обновлять свое сознание каждый день', historyNote: 'Арабская Ра (ر)' },
    { letter: 'ש', name: 'Шин', proto: '𓌓', meaning: 'Зуб', evolution: 'Рисовалась как три резца или боевой лук. Это символ огня и разрушительной энергии, которая необходима, чтобы уничтожить старое', number: 300, examples: ['שלום [Шалом] — Мир', 'שמים [Шамаим] — Небеса'], philosophy: 'Божественный огонь и баланс. Три ветви Шин символизируют истину, правосудие и мир', historyNote: 'Арабская Шин (ش)' },
    { letter: 'ת', name: 'Тав', proto: '𓏴', meaning: 'Знак / Печать', evolution: 'Изначально выглядела как крест или метка. Это была печать владельца или знак завершения работы. Тав ставит точку в алфавите', number: 400, examples: ['תורה [Тора] — Учение', 'תפילה [Тфила] — Молитва'], philosophy: 'Завершенность, истина и печать Творца на творении. Тав учит доводить дело до финала', historyNote: 'Арабская Та (ت)' },
  ];
